...
import {
  ...
  CheckCircle2, Clock, XCircle, AlertCircle, Eye, EyeOff, X, Utensils,
  ShieldCheck, Lock, LogOut, KeyRound, Loader2, Home, Info,
  Package, Menu as MenuIcon, Save, Plus, Trash2, Upload, Image as ImageIcon, Heart, Moon, Sun
} from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  return (
    <div className={`${theme === 'dark' ? 'dark' : ''} h-screen overflow-hidden bg-gray-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans flex flex-col md:flex-row`}>

      {/* Sidebar Component */}
      <aside className="w-full md:w-64 bg-white dark:bg-zinc-900 border-r border-gray-200 dark:border-zinc-800 shrink-0 flex flex-col h-full overflow-hidden">
              ...
              return (
                <button
                  ...
                  className={`w-full px-4 py-3 rounded-xl font-bold text-xs transition-all flex items-center justify-between cursor-pointer ${isActive
                      ...
                      : 'text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:text-zinc-100 hover:bg-gray-100 dark:bg-gray-100/80 dark:bg-zinc-800/80'
                    }`}
                >
        ...
        {activeTab === 'assets' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    <ImageIcon className="w-5 h-5 text-rose-500" />
                    <h3 className="font-heading font-bold text-base text-zinc-900 dark:text-white">Primary Logo</h3>
                  </div>
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">Used for Footer, Browser Favicon, and App Splash Screen</p>
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">Horizontal/Side logo displayed exclusively in the top navigation bar</p>
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">Appears behind the main title on the home page hero section</p>

                  <div className="aspect-video rounded-xl bg-gray-50 dark:bg-zinc-950 border border-dashed border-gray-300 dark:border-zinc-700 overflow-hidden relative group flex items-center justify-center">
                    <img 
                ...
                <div className="pt-3 border-t border-gray-200 dark:border-zinc-800/80">
                  ...
                  <button
                    ...
                    className="py-2.5 px-3 rounded-xl bg-gray-100 dark:bg-zinc-800 hover:bg-zinc-700 text-zinc-900 dark:text-white font-bold text-xs flex items-center gap-1.5 cursor-pointer shrink-0"
                  >
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">Character mascot displayed in the About section</p>
                  ...
                  <div key={pkg.id || idx} className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 space-y-4">
                    ...
                    <div className="flex items-center justify-between pb-3 border-b border-gray-200 dark:border-zinc-800">
                      ...
                      <button
                        ...
                        className="p-2 rounded-xl bg-rose-500/10 hover:bg-rose-500 text-rose-400 hover:text-zinc-900 dark:hover:text-white transition-colors cursor-pointer"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 rounded-xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 text-xs text-amber-300 font-bold focus:border-rose-500 focus:outline-none"
                        />
                      </div>
                      <div className="space-y-1">
                    ...
                    <div className="space-y-2 pt-2 border-t border-gray-200 dark:border-zinc-800/60">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-gray-100 dark:bg-zinc-800 hover:bg-zinc-700 text-xs text-emerald-400 font-semibold flex items-center gap-1 cursor-pointer transition-colors"
                        >
                        ...
                        {(pkg.features || []).map((feat, fIdx) => (
                          <div key={fIdx} className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg bg-rose-500/10 hover:bg-rose-500 text-rose-400 hover:text-zinc-900 dark:hover:text-white transition-colors cursor-pointer"
                    ...
                    <div className="flex-1 space-y-3 w-full">
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <button
                          ...
                          className="p-2 rounded-xl bg-rose-500/10 hover:bg-rose-500 text-rose-400 hover:text-zinc-900 dark:hover:text-white transition-colors cursor-pointer self-end"
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 rounded-xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 text-xs text-amber-300 font-bold"
                          />
                        </div>
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1.5">
                        <input
                          ...
                          className="w-full px-3 py-2 rounded-xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 text-xs text-amber-300 outline-none focus:border-rose-500 font-mono"
                        />
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 rounded-xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 text-xs text-amber-300 focus:border-rose-500 font-medium"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 rounded-xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 text-xs text-emerald-300 italic focus:border-rose-500"
                          />
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 text-sm text-amber-300 outline-none focus:border-rose-500 font-mono"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 text-sm text-pink-400 outline-none focus:border-rose-500 font-mono"
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 text-sm text-emerald-400 outline-none focus:border-rose-500 font-mono"
                    />
                  </div>
          ...
          <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-4 rounded-2xl bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800/80 flex items-center justify-between gap-4">
              ...
              <select
                ...
                className="px-3 py-1.5 rounded-xl bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-700 text-xs font-bold text-rose-400 focus:border-rose-500 outline-none cursor-pointer"
              >
